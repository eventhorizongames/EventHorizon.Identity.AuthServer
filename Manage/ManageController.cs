...
namespace EventHorizon.Identity.AuthServer.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        ...
        private async Task ReplaceClaim(IList<Claim> claimList, ApplicationUser user, string claimType, string claimValue)
        {
            ...
            if (userClaim != null)
            {
                ...
                {
                    await _userManager.ReplaceClaimAsync(user, userClaim, new Claim(claimType, claimValue));
                }
            }
            else
            {
